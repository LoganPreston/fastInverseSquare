...
double runFastInversSqrtTestShort(float num, int iters, testStats_t *testStats)
{
...
int main(void)
{
	...
	for (int i = 0; i < testIters; i++)
	{
		...
		runFastInversSqrtTestShort(num,squareRootIters,&testShort);
		...
		fprintf(outFile, outFormat, num, testBase.elapsed_sec, testBase.elapsed_msec,
				...
				testShort.elapsed_sec, testShort.elapsed_msec, testShort.accuracy);
